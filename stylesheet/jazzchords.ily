...
#(define-markup-command (acMin layout props extension) (string?)
  (interpret-markup layout props
    (markup #:super (#:concat (#:hspace 0.2 #:raise 0.5 #:fontsize -2 #:musicglyph "scripts.tenuto")) #:super extension)))

% for major chords, use "acMaj" to print a small "maj"
#(define-markup-command (acMaj layout props extension) (string?)
  (interpret-markup layout props
    (markup #:super #:fontsize -2 "maj" #:super #:fontsize -1 extension)))
...
#(define-markup-command (acFlat layout props extension) (string?)
  (interpret-markup layout props
    (markup #:super #:fontsize 2 ">" #:super #:raise 0.3 #:fontsize -1 extension)))
