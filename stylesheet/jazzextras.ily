...
startChordBracket = #(define-music-function (parser location note)
(ly:music?)
"Add an opened parenthesis to the left of `chord"
#{
\once \override ChordNames.Parentheses.stencils = #(my-stencils #t)
\parenthesize $note
#})

endChordBracket = #(define-music-function (parser location note) (ly:music?)
"Add a closed parenthesis to the right of `chord"
#{
\once \override ChordNames.Parentheses.stencils = #(my-stencils #f)
\parenthesize $note
#})